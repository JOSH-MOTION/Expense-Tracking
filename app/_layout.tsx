      ...
      <View style={ls.bg}>
        <View style={ls.card}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
          >
            <Text style={ls.btnTxt}>
              {trying ? "Verifying..." : "Unlock with Biometrics"}
            </Text>
          </TouchableOpacity>
        </View>
      </View>
...
function AppContent() {
  ...
  // Lock after 3 seconds in background
  ...
  useEffect(() => {
    const sub = AppState.addEventListener("change", async (nextState) => {
      ...
      if (
        ...
        // App coming back — check how long it was in background
  ...
  return (
    <ThemeProvider value={colorScheme === "dark" ? DarkTheme : DefaultTheme}>
      ...
      {/* Lock screen — shown on top of everything when locked */}
