      ...
      >
        ...
        <TouchableOpacity style={styles.profileCard} activeOpacity={0.8}>
          ...
          <View style={styles.profileInfo}>
            ...
            <Text style={styles.profilePhone}>{displaySub}</Text>
          </View>
          <Text style={styles.chevron}>›</Text>
        </TouchableOpacity>
        ...
        <View style={styles.card}>
          ...
          <Divider />
          <SettingRow
            icon="log-out" iconBg="#FEE2E2"
            title="Log Out" danger onPress={handleLogout}
          />
        </View>
...
const styles = StyleSheet.create({
  ...
  profilePhone:   { fontSize: 14, color: TEXT_SECONDARY },
  sectionLabel: {
